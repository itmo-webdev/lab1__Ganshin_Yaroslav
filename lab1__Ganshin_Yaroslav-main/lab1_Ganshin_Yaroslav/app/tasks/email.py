...
from lab1_Ganshin_Yaroslav.app.models import User, News
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=5, retry_backoff_max=300, retry_jitter=True, max_retries=5, name="lab1_Ganshin_Yaroslav.app.tasks.email.notify_new_news")
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=10, retry_backoff_max=600, retry_jitter=True, max_retries=5, name="lab1_Ganshin_Yaroslav.app.tasks.email.weekly_digest")
