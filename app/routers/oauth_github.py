...
from ..cache import set_json, sadd
from datetime import datetime
import uuid
from ..security import create_access_token, REFRESH_TOKEN_EXPIRE_MINUTES
...
async def github_callback(request: Request, db: AsyncSession = Depends(get_db)):
    ...
    async with github_sso:
        ...
        refresh = await _create_refresh_session(user, request.headers.get("user-agent", "unknown"))
        return {
            "access_token": access,
